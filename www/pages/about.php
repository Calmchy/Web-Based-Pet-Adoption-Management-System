...
<div class="container">                                                                              
    ...
    <p>                                                                                              
        ...
        duplicated records, slow application handling, and difficulty tracking
        applicant status. AdoptMe centralises all data in a secure MariaDB                           
    ...
    <ul>                                                                                             
        ...
        <li>Admin panel for pet listing management</li>                                              
        <li>Online adoption‑application submission</li>                                              
    ...
    <ul>               
        ...
        <li>Backend: PHP 8.3 (Apache)</li>        
        <li>Database: MariaDB 11 (phpMyAdmin for admin)</li>                                         
        <li>Containerised with Docker & Docker‑Compose</li>                                          
    </ul>                                                                                            
</div>